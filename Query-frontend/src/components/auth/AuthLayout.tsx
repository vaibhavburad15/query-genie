      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6">
          <div className="text-center lg:text-left">
            <Logo size="lg" className="justify-center lg:justify-start mb-4" />
            <h1 className="text-3xl font-bold text-foreground mb-4">Query Genie</h1>
            <p className="text-lg text-muted-foreground mb-6">
              Vaibhav Burad-Powered Database Chatbot
            </p>
          </div>

          <div className="space-y-4">
            <div>
              <h2 className="text-xl font-semibold text-foreground mb-2">What is Database Chatbot?</h2>
            ...
            <div>
              ...
              <ul className="text-muted-foreground space-y-2">
                ...
                <li>• <strong>Chat:</strong> Ask questions in natural language like "Show me all customers from New York"</li>
                <li>• <strong>Explore:</strong> View results in interactive tables and charts</li>
